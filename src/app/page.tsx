      ...
      <section className="pt-8 md:pt-14 pb-[60px] md:pb-[80px]">
        <div className="cf-container">
          <h1 className="text-center text-[24px] md:text-[32px] font-bold leading-[120%]">
            {variant === 'A' && (
              <span>
                BAJA ENTRE <span className="text-[#fbff00]">6 Y 15 KG DE GRASA CORPORAL EN 90 DÍAS</span> CON EL <span className="text-[#fbff00]">MÉTODO FIT90</span> - SIN DIETAS EXTREMAS NI RUTINAS IMPOSIBLES
              </span>
            )}
            {variant === 'B' && (
              <span>
                BAJA ENTRE <span className="text-[#fbff00]">6 Y 15 KG DE GRASA CORPORAL EN 90 DÍAS</span> CON MI <span className="text-[#fbff00]">MÉTODO FIT90</span> - SIN DIETAS EXTREMAS NI RUTINAS IMPOSIBLES
              </span>
            )}
          </h1>
